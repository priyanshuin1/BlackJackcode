...
//Get tabel information how many player are there in the tabel
    this.getTableInfo = function() {
        tableInfo.isShowAvailable = this.getActivePlayers() === 2;
        return tableInfo;
    }
    //Check limit on tabel and how many seat is there
...
//Add player on tabel if seat is there
...
//Get all slot for player
    ...
    //Offer to side show b/w player player will be accepat and reject
    ...
    //If accepat then that function work
...
//---------Get active player in tabel 
    ...
    // If winner is announced then reset all player
